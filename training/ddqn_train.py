...
with open("configs/ddqn_config.yaml", "r") as f:
...
def trainer(config):
    ...
    video_path = record_game(env,agent,prefix ="ddqn_agent",video_dir ="savevideos",seed=42)
...
if __name__ == "__main__":
    ...
    plot_training_curves(log,"ddqn_agent")
